...
// given an array with temp create function which takes the array and the return the temp with a string

const tempArr = [12, 23, 54];
const printForecast = function (arr) {
  for (let i = 0; i < arr.length; i++) {
    console.log(`${tempArr[i]}.c in ${i + 1}days`);
  }
};
